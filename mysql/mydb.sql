...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-12-2022 a las 17:20:39
...
INSERT INTO `documento` (`id`, `Id_Estudiante`, `Id_documento`, `Estado`) VALUES
(1, 2, 1, '1'),
(2, 2, 2, '0');
...
INSERT INTO `usuario` (`Usuario`, `Contraseña`, `id_rol`, `Estado`) VALUES
('10guevarafm1102@gmail.com', '123456789', 1, NULL),
('hola3@hotmail.com', '123456789', 2, NULL),
('pruebapepe@gmail.com', '123456789', 2, NULL);
...
ALTER TABLE `documento`
  ...
  ADD KEY `fk_documento_lista-documentos_id_idx` (`Id_documento`);
...
ALTER TABLE `documento`
  ...
  ADD CONSTRAINT `fk_documento_lista-documentos_id` FOREIGN KEY (`Id_documento`) REFERENCES `lista_documentos` (`Id`) ON DELETE CASCADE ON UPDATE CASCADE;
